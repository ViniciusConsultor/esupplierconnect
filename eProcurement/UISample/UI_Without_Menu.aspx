<%@ Page Language="C#" MasterPageFile="~/MasterPages/MasterPageSimple.master" AutoEventWireup="true" CodeFile="UI_Without_Menu.aspx.cs" Inherits="UISample_UI_Without_Menu" Title="Untitled Page" %>
            ...
            <td valign="top" style="height: 8px">
                <table id="tblSearch" cellspacing="0" cellpadding="1" width="100%" border="0">
                     <tr>
                        ...
                        <td><img style="cursor: hand; vertical-align:middle" id="img1" height="20" src="../Images/Common/Search.gif" runat="server" /></td>
                        <td>&nbsp;</td> 
                        <td style="text-align: left" style="width: 100%;">
                            <asp:Button ID="Button1" runat="server" Text="Filter"/>
                            <asp:Button ID="Button3" runat="server" Text="ShowAll"/>
                        </td>
                    </tr>
                </table>
            </td>
