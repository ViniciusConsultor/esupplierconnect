...
namespace eProcurement_DAL
{
    ...
    {
        #region RetrieveAll
        public static Collection<ContractItem> RetrieveAll()
        {
            return Retrieve(null, "", "");
        }

        public static Collection<ContractItem> RetrieveAll(string sortClaues)
        {
            return Retrieve(null, "", sortClaues);
        }

        public static Collection<ContractItem> RetrieveAll(EpTransaction epTran)
        {
            return Retrieve(epTran, "", "");
        }

        public static Collection<ContractItem> RetrieveAll(EpTransaction epTran, string sortClaues)
        {
        ...
        public static Collection<ContractItem> RetrieveByQuery(string whereClause)
        {
            return Retrieve(null, whereClause, "");
        }

        public static Collection<ContractItem> RetrieveByQuery(string whereClause, string sortClaues)
        {
            return Retrieve(null, whereClause, sortClaues);
        }

        public static Collection<ContractItem> RetrieveByQuery(EpTransaction epTran, string whereClause)
        {
            return Retrieve(epTran, whereClause, "");
        }

        public static Collection<ContractItem> RetrieveByQuery(EpTransaction epTran, string whereClause, string sortClaues)
        {
        ...
        public static ContractItem RetrieveByKey(string contractNumber, string contractItemSequence)
        {
        ...
        #region Insert
        public static void Insert(ContractItem entity)
        {
            Insert(null, entity);
        }
        ...
        #region Update
        public static void Update(ContractItem entity)
        {
            Update(null, entity);
        }

        public static void Update(EpTransaction epTran, ContractItem entity)
        {
            SqlCommand cm = new SqlCommand();
            cm.CommandType = CommandType.Text;
        ...
        #region Delete
        public static void Delete(ContractItem entity)
        {
            Delete(null, entity);
        }
