...
{
    public class ContractHeaderDAO
    {       
        #region RetrieveAll
        public static Collection<ContractHeader> RetrieveAll()
        {
            return Retrieve(null, "", "");
        }

        public static Collection<ContractHeader> RetrieveAll(string sortClaues)
        {
            return Retrieve(null, "", sortClaues);
        }

        public static Collection<ContractHeader> RetrieveAll(EpTransaction epTran)
        {
            return Retrieve(epTran, "", "");
        }

        public static Collection<ContractHeader> RetrieveAll(EpTransaction epTran, string sortClaues)
        {
        ...
        public static Collection<ContractHeader> RetrieveByQuery(string whereClause)
        {
            return Retrieve(null, whereClause, "");
        }

        public static Collection<ContractHeader> RetrieveByQuery(string whereClause, string sortClaues)
        {
            return Retrieve(null, whereClause, sortClaues);
        }

        public static Collection<ContractHeader> RetrieveByQuery(EpTransaction epTran, string whereClause)
        {
            return Retrieve(epTran, whereClause, "");
        }

        public static Collection<ContractHeader> RetrieveByQuery(EpTransaction epTran, string whereClause, string sortClaues)
        {
        ...
        public static ContractHeader RetrieveByKey(string ContractNumber)
        {
            return RetrieveByKey(null, ContractNumber);
        }

        public static ContractHeader RetrieveByKey(EpTransaction epTran, string ContractNumber)
        {
        ...
        #region Insert
        public static void Insert(ContractHeader entity)
        {
            Insert(null, entity);
        }
        ...
        #region Update
        public static void Update(ContractHeader entity)
        {
            Update(null, entity);
        }

        public static void Update(EpTransaction epTran, ContractHeader entity)
        {
            SqlCommand cm = new SqlCommand();
            cm.CommandType = CommandType.Text;
        ...
        #region Delete
        public static void Delete(ContractHeader entity)
        {
            Delete(null, entity);
        }

        public static void Delete(EpTransaction epTran, ContractHeader entity)
        {
            SqlCommand cm = new SqlCommand();
            cm.CommandType = CommandType.Text;
