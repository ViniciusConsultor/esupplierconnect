    ...
    <asp:Table ID="tblNavigation" CellSpacing="0" CellPadding="0" runat="server" Width="100%">
        <asp:TableHeaderRow>
            <asp:TableCell CssClass="navigation" VerticalAlign="Middle">
                <asp:Label ForeColor="White" ID="lblSubPath" runat="server">Acknownledge Purchase Contract</asp:Label></asp:TableCell>
        </asp:TableHeaderRow>
    </asp:Table>
    ...
    <table id="DetailsTable" width="100%" border="2" cellspacing="2" cellpadding="2" bordercolor="Gainsboro">
     ...
     <table cellspacing="0" cellpadding="0" width="100%" border="0">
        <tr>
            ...
            <td nowrap="nowrap">&nbsp;</td>
             <td nowrap="nowrap">
               <asp:Button ID="btnAck1" runat="server" Text="Acknowledge" onclick="btnAck_Click"/>
            </td>
            <td nowrap="nowrap">&nbsp;</td>
            <td nowrap="nowrap">
    ...
    <br />
     <table cellspacing="0" cellpadding="0" width="100%" border="0">
        <tr>
            ...
            <td nowrap="nowrap">&nbsp;</td>
            <td nowrap="nowrap">
               <asp:Button ID="btnAck" runat="server" Text="Acknowledge" onclick="btnAck_Click"/>
            </td>
            <td nowrap="nowrap">&nbsp;</td>
            <td nowrap="nowrap">
