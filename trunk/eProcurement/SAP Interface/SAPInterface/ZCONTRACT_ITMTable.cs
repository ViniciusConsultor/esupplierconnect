...
{
  /// <summary>
  /// A typed collection of ZCONTRACT_ITM elements.
  /// </summary>
  [Serializable]
  public class ZCONTRACT_ITMTable : SAPTable 
  {
  
    /// <summary>
    /// Returns the element type ZCONTRACT_ITM.
    /// </summary>
    /// <returns>The type ZCONTRACT_ITM.</returns>
    public override Type GetElementType() 
    {
        return (typeof(ZCONTRACT_ITM));
    }

    /// <summary>
    /// Creates an empty new row of type ZCONTRACT_ITM.
    /// </summary>
    /// <returns>The newZCONTRACT_ITM.</returns>
    public override object CreateNewRow()
    { 
        return new ZCONTRACT_ITM();
    }
     
    /// <summary>
    /// The indexer of the collection.
    /// </summary>
    public ZCONTRACT_ITM this[int index] 
    {
        get 
        {
            return ((ZCONTRACT_ITM)(List[index]));
        }
        set 
        {
            List[index] = value;
