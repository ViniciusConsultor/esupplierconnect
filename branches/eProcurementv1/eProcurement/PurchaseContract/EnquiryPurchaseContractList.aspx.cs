...
public partial class PurchaseContract_EnquiryPurchaseContractList : BaseForm
{
    ...
    private void InitPage()
    {
        try
        {
            if (string.Compare(base.LoginUser.ProfileType,ProfileType.Supplier, false) == 0)
            {
                txtSupplierId.Text = base.LoginUser.SupplierId;
                txtSupplierId.Enabled = false;
                imgSupplierSearch.Visible = false;
            }
            else if (string.Compare(base.LoginUser.ProfileType, ProfileType.Buyer, false) == 0)
            {
                txtSupplierId.Text = "";
                txtSupplierId.Enabled = true;
                imgSupplierSearch.Visible = true;
            }
            else 
            {
    ...
    protected void hlContractNo_OnClick(object sender, System.EventArgs e)
    {
        try
        {
            ...
            url = "~/PurchaseContract/ViewPurchaseContractDetail.aspx?FunctionId=" + base.m_FunctionId;
