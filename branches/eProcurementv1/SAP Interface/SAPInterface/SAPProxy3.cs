...
namespace SAPInterface
{
  ...
  public class SAPProxy3 : SAPClient
  {
    ...
    /// <param name="Purchase_History">Purchase Order Header Text - Work Area</param>
     ...
     ref ZORDER_SRVTSKTable Purchase_Service_Task)
    {
        ...
        results = this.SAPInvoke("Zretrieveorder",new object[] {
                            Purchase_Component,Purchase_Header,Purchase_Header_Text,Purchase_History,Purchase_Item,Purchase_Item_Text,Purchase_Schedule,Purchase_Service_Item,Purchase_Service_Task });
        ...
        Purchase_History = (ZORDER_HISTORYTable) results[3];
        Purchase_Item = (ZORDER_ITMTable) results[4];
        Purchase_Item_Text = (ZORDER_ITMTXTTable) results[5];
        Purchase_Schedule = (ZORDER_SCHTable) results[6];
        Purchase_Service_Item = (ZORDER_SRVTable) results[7];
        Purchase_Service_Task = (ZORDER_SRVTSKTable) results[8];
